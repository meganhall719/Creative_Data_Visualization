...
Now, what I'd really like to do is play a 5-second snippet for each of the averaged trials. For example, Trial 1 would be 'Von Dutch,' playing for 5 seconds, then 'Rewind' for Trial 2, and so on. I would enjoy it since I’ve listened to the album a trillion times and have the order memorized, but I can't do that here on r so 'Se la vie.'
